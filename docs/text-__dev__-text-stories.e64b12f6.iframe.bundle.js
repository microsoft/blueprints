...
(self.webpackChunkarbutus = self.webpackChunkarbutus || []).push([
  [5839],
  {
    ...
    './components/text/__dev__/text.stories.tsx': (
      ...
      const colorMap = {
          accent: tokens.T.colorBrandForeground1,
          action: tokens.T.colorBrandForeground2,
        ...
        colorClasses = (0, map_to_styles.f)(colorMap, (color) => ({ color })),
        variantClasses = {
          jumbo: {
            fontFamily: tokens.T.fontFamilyBase,
            fontSize: tokens.T.fontSizeHero1000,
            lineHeight: tokens.T.lineHeightHero1000,
            fontWeight: tokens.T.fontWeightBold,
          },
          title: {
            fontFamily: tokens.T.fontFamilyBase,
            fontSize: tokens.T.fontSizeHero800,
            lineHeight: tokens.T.lineHeightHero800,
            fontWeight: tokens.T.fontWeightSemibold,
          },
          subtitle: {
            fontFamily: tokens.T.fontFamilyBase,
            fontSize: tokens.T.fontSizeHero700,
            lineHeight: tokens.T.lineHeightHero700,
            fontWeight: tokens.T.fontWeightSemibold,
          },
          headline: {
            fontFamily: tokens.T.fontFamilyBase,
            fontSize: tokens.T.fontSizeBase500,
            lineHeight: tokens.T.lineHeightBase500,
            fontWeight: tokens.T.fontWeightSemibold,
          },
          leading: {
            fontFamily: tokens.T.fontFamilyBase,
        ...
        useTextStyles = (0, makeStyles_esm.Z)({
          ...colorClasses,
          ...variantClasses,
          root: { ...index_esm.q5.margin(0), ...index_esm.q5.padding(0) },
          code: {
            display: 'inline-block',
            fontFamily: tokens.T.fontFamilyMonospace,
            fontSize: tokens.T.fontSizeBase300,
            lineHeight: tokens.T.lineHeightBase300,
            backgroundColor: tokens.T.colorNeutralBackground3,
            ...index_esm.q5.borderRadius(tokens.T.borderRadiusSmall),
      ...
      const text_Text = ({
        ...
        const rootClasses = (0, mergeClasses_esm.z)(
          classes.root,
          classes[color],
          variantClass,
          className,
        );
        return (0, jsx_runtime.jsx)(Text.x, {
          weight,
          size,
          font,
      ...
      try {
        (text_Text.displayName = 'Text'),
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES['components/text/src/text/text.tsx#Text'] = {
              docgenInfo: text_Text.__docgenInfo,
              name: 'Text',
              path: 'components/text/src/text/text.tsx#Text',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      const text_stories = {
          title: 'Atoms/Text',
          ...
          argTypes: {
            ...
            color: { options: Object.keys(colorClasses), control: { type: 'select' } },
          },
          decorators: [
            (Story) =>
        ...
        Template = (args) =>
          (0, jsx_runtime.jsx)(text_Text, {
            block: !0,
            ...args,
            children:
              'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cupiditate modi eveniet dolorum officiis assumenda similique a voluptas voluptatum ducimus temporibus. Culpa animi labore molestiae nesciunt suscipit, architecto optio sit iusto.',
          });
      ...
      const CodeTemplate = (args) =>
        (0, jsx_runtime.jsx)(text_Text, {
          block: !0,
          ...args,
          children: '<Text variant="code">Hello!</Text>',
        });
      CodeTemplate.displayName = 'CodeTemplate';
      const Simple = Template.bind({});
      Simple.args = { color: 'primary', variant: 'paragraph' };
      const Code = CodeTemplate.bind({});
      Code.args = { variant: 'code' };
      const useGridStyles = (0, makeStyles_esm.Z)({
          root: { maxWidth: '60rem' },
          article: {
            display: 'grid',
        ...
        TemplateDemo = () => {
          const space = (0, use_space_styles.z)(),
            grid = useGridStyles(),
            imageClasses = (0, mergeClasses_esm.z)(grid.image, space.mb4);
          return (0, jsx_runtime.jsxs)('main', {
            className: (0, mergeClasses_esm.z)(space.pb12, grid.root),
            children: [
              (0, jsx_runtime.jsx)(text_Text, {
                block: !0,
                as: 'h1',
              ...
              (0, jsx_runtime.jsx)(text_Text, {
                ...
                variant: 'leading',
                children:
                  'Leading Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cupiditate modi eveniet dolorum officiis assumenda similique a voluptas voluptatum ducimus temporibus. Culpa animi labore molestiae nesciunt suscipit, architecto optio sit iusto.',
              }),
              (0, jsx_runtime.jsx)(divider.i, { className: space.my8 }),
              (0, jsx_runtime.jsx)(text_Text, {
                block: !0,
                as: 'h2',
                variant: 'subtitle',
              ...
              (0, jsx_runtime.jsx)(text_Text, {
                ...
                className: space.mb8,
                children:
                  'Paragraph Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cupiditate modi eveniet dolorum officiis assumenda similique a voluptas voluptatum ducimus temporibus. Culpa animi labore molestiae nesciunt suscipit, architecto optio sit iusto.',
              }),
                  ...
                  (0, jsx_runtime.jsxs)('section', {
                    children: [
                      ...
                      (0, jsx_runtime.jsx)(text_Text, {
                        ...
                        className: space.mb1,
                        color: 'positive',
                        children: 'Caption: What do you see?',
                      }),
                      (0, jsx_runtime.jsx)(text_Text, {
                        block: !0,
                        variant: 'description',
                        color: 'tertiary',
                        children:
                          'Description: Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cupiditate modi eveniet dolorum officiis assumenda similique a voluptas voluptatum ducimus temporibus. Culpa animi labore molestiae nesciunt suscipit, architecto optio sit iusto.',
                      }),
                    ],
                  }),
                  (0, jsx_runtime.jsxs)('section', {
              ...
              (0, jsx_runtime.jsx)(divider.i, { className: space.my12 }),
              (0, jsx_runtime.jsxs)('div', {
                className: grid.article,
                children: [
                  (0, jsx_runtime.jsxs)('section', {
      ...
      TemplateDemo.displayName = 'TemplateDemo';
      const StylesDemo = TemplateDemo.bind({}),
        __namedExportsOrder = ['Simple', 'Code', 'StylesDemo'];
    },
    './hooks/use-space-styles/lib/use-space-styles.js': (
      __unused_webpack_module,
      __webpack_exports__,
