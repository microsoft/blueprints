    ...
    './styles/theming/__dev__/theming.stories.tsx': (
      ...
      __webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          ...
          default: () => theming_stories,
        });
      var button_button = __webpack_require__('./components/button/lib/button/button.js'),
      ...
      const buttonHeight = tokens.T.spacingVerticalXXL,
        ...
        ThemeSwitch = ({ className, label = 'Dark mode', isDark, onToggle }) => {
          ...
          return react.createElement(
            ...
            react.createElement(reach_visually_hidden.T, null, label),
      ...
      ThemeSwitch.__docgenInfo = {
        ...
        props: {
          label: { defaultValue: { value: "'Dark mode'", computed: !1 }, required: !1 },
        },
      };
      ...
      const arbutusBrandRamp = {
        ...
        ThemeContext = (0, react.createContext)({
          theme: (0, createLightTheme.f)(arbutusBrandRamp),
          themeKey: 'light',
        });
      ...
      const breakpoints = {
        ...
        layout = { mobile: 0, tablet: 768, desktop: 1140, ultraWide: 1440 },
        arbutusTokens = {
          light: {
      ...
      const ThemeProvider = ({
        ...
        return (
          ...
          (0, jsx_runtime.jsx)(ThemeContext.Provider, {
            ...
            children: (0, jsx_runtime.jsx)(FluentProvider.r, { theme, children }),
          })
        );
      };
          ...
          (ThemeProvider.__docgenInfo = {
            ...
            props: {
              ...
              themes: {
                ...
                name: 'themes',
                required: !1,
                type: { name: 'Record<ColorScheme, Theme>' },
              },
              currentThemeKey: {
                defaultValue: null,
                description: '',
                name: 'currentThemeKey',
                required: !1,
                type: {
                  name: 'enum',
                  value: [{ value: '"light"' }, { value: '"dark"' }],
              ...
              setThemeKey: {
                ...
                name: 'setThemeKey',
                required: !1,
                type: { name: '(themeKey: ColorScheme) => void' },
              },
            },
          }),
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'styles/theming/src/theme-provider.tsx#ThemeProvider'
            ] = {
              docgenInfo: ThemeProvider.__docgenInfo,
              name: 'ThemeProvider',
              path: 'styles/theming/src/theme-provider.tsx#ThemeProvider',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      const DemoComponent = () => {
        const { themeKey, setTheme } = (() => {
            const { theme, themeKey, setTheme } = (0, react.useContext)(ThemeContext);
            return { theme, themeKey, setTheme };
          })(),
          isDark = 'dark' === themeKey;
        return (0, jsx_runtime.jsxs)(decorators.z, {
          children: [
            (0, jsx_runtime.jsx)(ThemeSwitch, {
              isDark,
            ...
            (0, jsx_runtime.jsx)(text_text.x, {
              ...
              block: !0,
              variant: 'title',
              children: 'Welcome to theming!',
            }),
            (0, jsx_runtime.jsx)(button_button.z, { children: 'I am a button' }),
          ],
        });
      };
      DemoComponent.displayName = 'DemoComponent';
      const theming_stories = { title: 'Styles/Theming' },
        Template = () =>
          (0, jsx_runtime.jsx)(ThemeProvider, {
            children: (0, jsx_runtime.jsx)(DemoComponent, {}),
          });
...
>>>>>>> 0a42c43 (Runs lint):docs/theming-__dev__-theming-stories.15f98458.iframe.bundle.js
