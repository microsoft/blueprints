    ...
    './components/bookmark-tile/__dev__/bookmark-tile.stories.tsx': (
      ...
      var makeStyles_esm = __webpack_require__(
        ...
        mergeClasses_esm =
          ...
          __webpack_require__('./node_modules/@griffel/core/mergeClasses.esm.js')),
      ...
      const useBookmarkTileStyles = (0, makeStyles_esm.Z)({
        root: {
          textAlign: 'left',
          cursor: 'pointer',
        ...
        fallbackIcon: {
          height: tokens.T.spacingHorizontalXXXL,
          width: tokens.T.spacingHorizontalXXXL,
          ...index_esm.q5.borderRadius(tokens.T.spacingHorizontalL),
      ...
      const BookmarkTile = ({
        ...
        return (0, jsx_runtime.jsx)(tile.n, {
          ...
          variant: 'card',
          onClick,
          className: (0, mergeClasses_esm.z)(classes.root, space.p9, className),
          children: (0, jsx_runtime.jsxs)('div', {
            children: [
              (0, jsx_runtime.jsxs)('header', {
                className: (0, mergeClasses_esm.z)(classes.header, space.mb7),
                children: [
                  iconSrc && iconAlt
                  ...
                  (0, jsx_runtime.jsx)(icon.J, { iconName: 'open', color: 'secondary' }),
                ],
              }),
      ...
      try {
        (BookmarkTile.displayName = 'BookmarkTile'),
          (BookmarkTile.__docgenInfo = {
            description: '',
            displayName: 'BookmarkTile',
            props: {
              className: {
                defaultValue: null,
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/bookmark-tile/src/bookmark-tile/bookmark-tile.tsx#BookmarkTile'
            ] = {
              docgenInfo: BookmarkTile.__docgenInfo,
              name: 'BookmarkTile',
              path: 'components/bookmark-tile/src/bookmark-tile/bookmark-tile.tsx#BookmarkTile',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      const theme_designer_namespaceObject =
          __webpack_require__.p + 'static/media/theme-designer.5a1ca2d4.png',
        bookmark_tile_stories = {
        ...
        Template = (args) => {
          ...
          return (0, jsx_runtime.jsxs)('div', {
            ...
            children: [
              ...
              (0, jsx_runtime.jsx)(BookmarkTile, { ...args }),
              (0, jsx_runtime.jsx)(tile.n, { variant: 'solid-color', children: ' ' }),
            ],
          });
        };
      ...
      Simple.args = {
        title: 'Link Name',
        description:
          'BookmarkTile communicates to the user that this is a link to a resource.',
      };
      const WithCustomIcon = Template.bind({});
      WithCustomIcon.args = {
        title: 'Fluent Theme Designer',
        description: 'Figma plugin',
        iconSrc: theme_designer_namespaceObject,
        iconAlt: 'Fluent Theme Designer',
      };
      const __namedExportsOrder = ['Simple', 'WithCustomIcon'];
    },
...
>>>>>>> 0a42c43 (Runs lint):docs/bookmark-tile-__dev__-bookmark-tile-stories.c10a30df.iframe.bundle.js
