    ...
    './components/aside-navigation/__dev__/aside-navigation.stories.tsx': (
      ...
      __webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          ...
          default: () => aside_navigation_stories,
        });
      ...
      const AsideNavigationContext = (0, react.createContext)({});
      var index_esm = __webpack_require__('./node_modules/@griffel/core/index.esm.js');
      const useAsideNavigationStyles = (0, makeStyles_esm.Z)({
        list: {
          display: 'grid',
          position: 'relative',
          gridTemplateColumns: '1fr',
          rowGap: tokens.T.spacingVerticalS,
          paddingLeft: tokens.T.spacingHorizontalS,
          ...index_esm.q5.borderLeft(
            tokens.T.strokeWidthThin,
            'solid',
            tokens.T.colorNeutralStroke1,
          ),
        },
        title: {
          ...index_esm.q5.borderLeft(
        ...
        highlight: {
          ...
          position: 'absolute',
          height: tokens.T.lineHeightBase600,
          width: tokens.T.strokeWidthThick,
          left: `calc(${tokens.T.strokeWidthThin} * -1)`,
          backgroundColor: tokens.T.colorBrandForeground1,
        },
      });
      ...
      const AsideNavigation = ({
        ...
        const classes = useAsideNavigationStyles(),
          ...
          highlightStyle = {
            top: `calc((100% + ${tokens.T.spacingVerticalS}) / ${count} * ${currentIndex})`,
          };
        return (0, jsx_runtime.jsx)(AsideNavigationContext.Provider, {
          value: { currentIndex },
          children: (0, jsx_runtime.jsxs)(Root, {
            className,
            children: [
              title &&
      ...
      try {
        (AsideNavigation.displayName = 'AsideNavigation'),
          (AsideNavigation.__docgenInfo = {
            description: '',
            displayName: 'AsideNavigation',
            props: {
              className: {
                defaultValue: null,
              ...
              title: {
                defaultValue: null,
                description: 'Title of the navigation group.',
                name: 'title',
                required: !1,
                type: { name: 'string' },
              },
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/aside-navigation/src/aside-navigation/aside-navigation.tsx#AsideNavigation'
            ] = {
              docgenInfo: AsideNavigation.__docgenInfo,
              name: 'AsideNavigation',
              path: 'components/aside-navigation/src/aside-navigation/aside-navigation.tsx#AsideNavigation',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      const useAsideNavigationLinkStyles = (0, makeStyles_esm.Z)({
          root: {
            ...index_esm.q5.padding(0, tokens.T.spacingHorizontalS),
            textAlign: 'left',
            height: tokens.T.lineHeightBase600,
            transitionProperty: 'all',
            transitionDuration: tokens.T.durationNormal,
          ...
          active: { fontWeight: tokens.T.fontWeightSemibold },
        }),
        AsideNavigationLink = ({ children, as: Root = 'button', onClick, index }) => {
          const classes = useAsideNavigationLinkStyles(),
            { currentIndex } = (0, react.useContext)(AsideNavigationContext),
            isActive = currentIndex === index;
          return (0, jsx_runtime.jsx)(Root, {
            onClick,
            className: (0, mergeClasses_esm.z)(classes.root),
            children: (0, jsx_runtime.jsx)(text_text.x, {
              as: 'span',
              color: isActive ? 'action' : 'secondary',
              className: isActive ? classes.active : void 0,
              children,
            }),
          });
        };
      ...
      try {
        (AsideNavigationLink.displayName = 'AsideNavigationLink'),
          (AsideNavigationLink.__docgenInfo = {
            description: '',
            displayName: 'AsideNavigationLink',
            props: {
              as: {
                defaultValue: null,
              ...
              onClick: {
                defaultValue: null,
                description: 'Link element click handler.',
                name: 'onClick',
                required: !0,
              ...
              index: {
                defaultValue: null,
                description: 'Element’s index (position) in the navigation.',
                name: 'index',
                required: !0,
                type: { name: 'number' },
              },
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/aside-navigation/src/aside-navigation-link/aside-navigation-link.tsx#AsideNavigationLink'
            ] = {
              docgenInfo: AsideNavigationLink.__docgenInfo,
              name: 'AsideNavigationLink',
              path: 'components/aside-navigation/src/aside-navigation-link/aside-navigation-link.tsx#AsideNavigationLink',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      const aside_navigation_stories = {
          title: 'Layout/AsideNavigation',
          component: AsideNavigation,
        },
        items = ['Overview', 'Variants', 'Layout', 'Accessibility', 'Content'],
        useNavigationStyles = (0, makeStyles_esm.Z)({
          root: {
            width: '100%',
            display: 'grid',
        ...
        Template = ({ title, currentIndex: _i }) => {
          const [currentIndex, setCurrentIndex] = (0, react.useState)(_i ?? 0);
          (0, react.useEffect)(() => setCurrentIndex(_i ?? 0), [_i]);
          const makeOnClick = (i) => () => setCurrentIndex(i),
            classes = useNavigationStyles();
          return (0, jsx_runtime.jsxs)('div', {
            ...
            children: [
              ...
              (0, jsx_runtime.jsx)(AsideNavigation, {
                currentIndex,
                title,
                children: items.map((item, i) =>
                  (0, jsx_runtime.jsx)(
                    AsideNavigationLink,
                    { index: i, onClick: makeOnClick(i), children: item },
                    `${i}--${item}`,
                  ),
                ),
              }),
      ...
      Simple.args = { currentIndex: 0, title: 'On this page' };
...
>>>>>>> 0a42c43 (Runs lint):docs/aside-navigation-__dev__-aside-navigation-stories.df225f4a.iframe.bundle.js
