    ...
    './components/action-list-tile/__dev__/action-list-tile.stories.tsx': (
      ...
      __webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          DownloadsExample: () => DownloadsExample,
          LinksExample: () => LinksExample,
          __namedExportsOrder: () => __namedExportsOrder,
          default: () => action_list_tile_stories,
        });
      ...
      const ActionListTile = ({ className, children }) => {
        const space = (0, use_space_styles.z)();
        return (0, jsx_runtime.jsx)(tile.n, {
          variant: 'card',
          className,
          children: (0, jsx_runtime.jsx)('div', { className: space.p9, children }),
        });
      };
      ActionListTile.displayName = 'ActionListTile';
      try {
        (ActionListTile.displayName = 'ActionListTile'),
          (ActionListTile.__docgenInfo = {
            description: '',
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/action-list-tile/src/action-list-tile/action-list-tile.tsx#ActionListTile'
            ] = {
              docgenInfo: ActionListTile.__docgenInfo,
              name: 'ActionListTile',
              path: 'components/action-list-tile/src/action-list-tile/action-list-tile.tsx#ActionListTile',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      ...
      const useActionListHeaderStyles = (0, makeStyles_esm.Z)({
          image: {
            height: tokens.T.spacingHorizontalXXXL,
            width: tokens.T.spacingHorizontalXXXL,
            objectFit: 'cover',
          },
        }),
        ActionListHeader = ({ className, title, iconSrc, iconAlt }) => {
          const classes = useActionListHeaderStyles(),
            space = (0, use_space_styles.z)();
          return (0, jsx_runtime.jsxs)('header', {
            className: (0, mergeClasses_esm.z)(space.mb3, className),
            children: [
              iconSrc &&
                (0, jsx_runtime.jsx)('img', {
                  src: iconSrc,
                  alt: iconAlt,
                  className: (0, mergeClasses_esm.z)(space.mb4, classes.image),
                }),
      ...
      ActionListHeader.displayName = 'ActionListHeader';
      try {
        (ActionListHeader.displayName = 'ActionListHeader'),
          (ActionListHeader.__docgenInfo = {
            description: '',
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/action-list-tile/src/action-list-header/action-list-header.tsx#ActionListHeader'
            ] = {
              docgenInfo: ActionListHeader.__docgenInfo,
              name: 'ActionListHeader',
              path: 'components/action-list-tile/src/action-list-header/action-list-header.tsx#ActionListHeader',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      const useActionListItemsStyles = (0, makeStyles_esm.Z)({
          root: {
            display: 'grid',
            gridTemplateColumns: '1fr',
            rowGap: tokens.T.spacingHorizontalS,
          },
        }),
        ActionListItems = ({ className, children }) => {
      ...
      ActionListItems.displayName = 'ActionListItems';
      try {
        (ActionListItems.displayName = 'ActionListItems'),
          (ActionListItems.__docgenInfo = {
            description: '',
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/action-list-tile/src/action-list-items/action-list-items.tsx#ActionListItems'
            ] = {
              docgenInfo: ActionListItems.__docgenInfo,
              name: 'ActionListItems',
              path: 'components/action-list-tile/src/action-list-items/action-list-items.tsx#ActionListItems',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      ...
      const useActionListItemStyles = (0, makeStyles_esm.Z)({
          root: {
            display: 'grid',
        ...
        ActionListItem = ({ className, label, iconName, onClick, description }) => {
          ...
          return (0, jsx_runtime.jsxs)('button', {
            ...
            children: [
              (0, jsx_runtime.jsxs)(text_text.x, {
                ...
                color: 'secondary',
                children: [
                  (0, jsx_runtime.jsx)(reach_visually_hidden.T, {
      ...
      try {
        (ActionListItem.displayName = 'ActionListItem'),
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/action-list-tile/src/action-list-item/action-list-item.tsx#ActionListItem'
            ] = {
              docgenInfo: ActionListItem.__docgenInfo,
              name: 'ActionListItem',
              path: 'components/action-list-tile/src/action-list-item/action-list-item.tsx#ActionListItem',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      const figma_namespaceObject =
          __webpack_require__.p + 'static/media/figma.0845e15a.png',
        action_list_tile_stories = {
        ...
        TileExample = ({ type }) =>
          (0, jsx_runtime.jsxs)(ActionListTile, {
            children: [
              'downloads' === type
                ? (0, jsx_runtime.jsx)(ActionListHeader, {
                    title: 'Figma Resources',
                    iconSrc: figma_namespaceObject,
                    iconAlt: 'Figma logo',
                  })
                : (0, jsx_runtime.jsx)(ActionListHeader, { title: 'Useful Links' }),
              (0, jsx_runtime.jsx)(ActionListItems, {
                children: actions[type].map((action, i) => {
                  return (0, jsx_runtime.jsx)(
                    ActionListItem,
                    {
                      label: action,
                      description: 'downloads' === type ? 'Download' : 'Go to',
                      iconName: 'downloads' === type ? 'download' : 'open',
                      onClick:
                        ((label = action),
      ...
      TileExample.displayName = 'TileExample';
      const DownloadsTemplate = () => {
        ...
        return (0, jsx_runtime.jsxs)('div', {
          ...
          children: [
            ...
            (0, jsx_runtime.jsx)(TileExample, { type: 'downloads' }),
            (0, jsx_runtime.jsx)(tile.n, { variant: 'solid-color', children: ' ' }),
          ],
        });
      };
      DownloadsTemplate.displayName = 'DownloadsTemplate';
      const DownloadsExample = DownloadsTemplate.bind({}),
        LinksTemplate = () => {
          const classes = useTileGridStyles();
          return (0, jsx_runtime.jsxs)('div', {
            className: classes.root,
            children: [
              (0, jsx_runtime.jsx)(tile.n, { variant: 'solid-color', children: ' ' }),
              (0, jsx_runtime.jsx)(TileExample, { type: 'links' }),
              (0, jsx_runtime.jsx)(tile.n, { variant: 'solid-color', children: ' ' }),
            ],
          });
        };
      LinksTemplate.displayName = 'LinksTemplate';
      const LinksExample = LinksTemplate.bind({}),
        __namedExportsOrder = ['DownloadsExample', 'LinksExample'];
    },
...
>>>>>>> 0a42c43 (Runs lint):docs/action-list-tile-__dev__-action-list-tile-stories.71d0a62f.iframe.bundle.js
