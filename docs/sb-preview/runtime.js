    ...
    var GetIntrinsic = require_get_intrinsic2(),
      ...
      listGetNode = function (list, key2) {
        for (var prev = list, curr; (curr = prev.next) !== null; prev = curr)
          if (curr.key === key2)
            return (
              (prev.next = curr.next), (curr.next = list.next), (list.next = curr), curr
            );
      },
    ...
    var getSideChannel = require_side_channel(),
      ...
      stringify2 = function stringify3(
        ...
        for (
          ...
          var key2 = objKeys[j],
            value2 =
              typeof key2 == 'object' && typeof key2.value < 'u' ? key2.value : obj[key2];
        ...
        (inherited || hasOwnProperty5.call(value2, key2)) &&
          !(
            ...
            (key2 == 'length' ||
              ...
              (isType &&
                (key2 == 'buffer' || key2 == 'byteLength' || key2 == 'byteOffset')) ||
              isIndex(key2, length))
          ) &&
          result2.push(key2);
      return result2;
...
var require_listCacheDelete = __commonJS({
  '../../node_modules/lodash/_listCacheDelete.js'(exports, module) {
    ...
    function listCacheDelete2(key2) {
      ...
      return (
        index == lastIndex ? data.pop() : splice2.call(data, index, 1), --this.size, !0
      );
    }
...
function listCacheSet(key2, value2) {
  var data = this.__data__,
    index = assocIndexOf_default(data, key2);
  return (
    index < 0 ? (++this.size, data.push([key2, value2])) : (data[index][1] = value2), this
  );
}
...
var import_qs = __toESM(require_lib(), 1),
      ...
      if (this.config.page === 'manager') {
        let list = Array.from(
          ...
          .filter((e) => {
            try {
              return (
                !!e.contentWindow && e.dataset.isStorybook !== void 0 && e.id === target
              );
            } catch {
              return !1;
            }
  ...
  getEventSourceUrl = (event) => {
    ...
    return (
      remainder.length > 0 && logger.error('found multiple candidates for event source'),
      null
    );
  };
...
function deleteUndefined(obj) {
  return (
    Object.keys(obj).forEach((key2) => obj[key2] === void 0 && delete obj[key2]), obj
  );
}
var ArgsStore = class {
    constructor() {
      ...
      var reNonASCII =
        ...
        getCodePoint =
          String.prototype.codePointAt != null
            ...
            : function (c2) {
                return (
                  (c2.charCodeAt(0) - 55296) * 1024 + c2.charCodeAt(1) - 56320 + 65536
                );
              };
  ...
  require_lib2 = __commonJS3({
    '../../node_modules/entities/lib/index.js'(exports) {
      ...
      function decodeStrict(data, level) {
        return (!level || level <= 0 ? decode_1.decodeXML : decode_1.decodeHTMLStrict)(
          data,
        );
      }
...
var getQueryString = ({ selection, extraParams }) => {
  ...
  WebView = class {
    ...
    prepareForDocs() {
      return (
        this.showMain(), this.showDocs(), this.applyLayout('fullscreen'), this.docsRoot()
      );
    }
    docsRoot() {
