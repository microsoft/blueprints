...
(self.webpackChunkarbutus = self.webpackChunkarbutus || []).push([
  [7719],
  {
    ...
    './components/link/__dev__/link.stories.tsx': (
      ...
      const useLinkStyles = (0, makeStyles_esm.Z)({
        root: {
          cursor: 'pointer',
        ...
        flexLayout: { columnGap: tokens.T.spacingHorizontalS },
      });
      var jsx_runtime = __webpack_require__('./node_modules/react/jsx-runtime.js');
      const getTextProps = ({ variant }) => {
          switch (variant) {
            case 'display':
        ...
        Link = ({
          ...
          const space = (0, use_space_styles.z)(),
            ...
            isComplexVariant = ['display', 'accent'].includes(variant);
          return (0, jsx_runtime.jsxs)(Link, {
            ...
            children: [
              isComplexVariant &&
                (0, jsx_runtime.jsx)(icon.J, {
                  ...
                  size: 'display' === variant ? 'large' : 'medium',
                  className: (0, mergeClasses_esm.z)(
                    'display' === variant ? space.mr3 : space.mr1,
                    'display' === variant && space.mt1,
                  ),
                }),
      ...
      try {
        (Link.displayName = 'Link'),
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES['components/link/src/link/link.tsx#Link'] = {
              docgenInfo: Link.__docgenInfo,
              name: 'Link',
              path: 'components/link/src/link/link.tsx#Link',
            });
      ...
      LinkSample.displayName = 'LinkSample';
      const Template = (args) => (0, jsx_runtime.jsx)(Link, { ...args });
      Template.displayName = 'Template';
      const Simple = Template.bind({});
      Simple.args = { children: 'Simple Link Example', as: LinkSample };
      const IsUnderlined = Template.bind({});
      IsUnderlined.args = {
      ...
      WithIcon.args = { children: 'Open in new tab', withIcon: !0, as: LinkSample };
      const __namedExportsOrder = ['Simple', 'IsUnderlined', 'WithIcon'];
    },
