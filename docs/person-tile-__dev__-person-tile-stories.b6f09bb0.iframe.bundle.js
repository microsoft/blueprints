<<<<<<< HEAD:docs/person-tile-__dev__-person-tile-stories.b6f09bb0.iframe.bundle.js
    ...
    './components/person-tile/__dev__/person-tile.stories.tsx': (
      ...
      const PersonTile = ({
        ...
        return (0, jsx_runtime.jsxs)(tile.n, {
          ...
          children: [
            (0, jsx_runtime.jsx)(Avatar.q, {
              size: 40,
              image: { as: 'img', src: avatarSrc, 'aria-hidden': !0 },
            }),
            ...
            iconSrc && iconAlt
              ? (0, jsx_runtime.jsx)('img', {
                  src: iconSrc,
                  alt: iconAlt,
                  className: (0, mergeClasses_esm.z)(classes.image, space.px3),
                })
      ...
      try {
        (PersonTile.displayName = 'PersonTile'),
          (PersonTile.__docgenInfo = {
            description: '',
            displayName: 'PersonTile',
            props: {
              className: {
                defaultValue: null,
              ...
              onClick: {
                defaultValue: null,
                description: 'Action that handles click on the person tile.',
                name: 'onClick',
                required: !0,
              ...
              image: {
                ...
                required: !1,
                type: {
                  name: '{ as?: "img"; } & Omit<Omit<DetailedHTMLProps<ImgHTMLAttributes<HTMLImageElement>, HTMLImageElement>, "ref"> & { ...; }, "children"> & { ...; }',
                },
              },
              iconSrc: {
                defaultValue: null,
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/person-tile/src/person-tile/person-tile.tsx#PersonTile'
            ] = {
              docgenInfo: PersonTile.__docgenInfo,
              name: 'PersonTile',
              path: 'components/person-tile/src/person-tile/person-tile.tsx#PersonTile',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      const avatar_namespaceObject =
          __webpack_require__.p + 'static/media/avatar.3e128d47.jpg',
        teams_icon_namespaceObject =
          __webpack_require__.p + 'static/media/teams-icon.22fada98.svg',
        person_tile_stories = {
          title: 'Tiles/PersonTile',
          component: PersonTile,
          argTypes: { onClick: { action: 'clicked' } },
        },
        Template = (args) => (0, jsx_runtime.jsx)(PersonTile, { ...args });
      ...
      Simple.args = {
        ...
        avatarSrc: avatar_namespaceObject,
      };
      ...
      WithCustomIcon.args = {
        ...
        role: 'Software Engineer',
        avatarSrc: avatar_namespaceObject,
        iconSrc: teams_icon_namespaceObject,
...
>>>>>>> 0a42c43 (Runs lint):docs/person-tile-__dev__-person-tile-stories.7068546b.iframe.bundle.js
