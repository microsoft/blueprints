    ...
    './components/mark-list/__dev__/mark-list.stories.tsx': (
      ...
      __webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          ...
          default: () => mark_list_stories,
        });
      var makeStyles_esm = __webpack_require__(
          './node_modules/@griffel/react/makeStyles.esm.js',
        ),
        icons = __webpack_require__('./components/icon/lib/icon/icons/index.js'),
        icon_styles = __webpack_require__('./components/icon/lib/icon/icon.styles.js'),
      ...
      const MarkListContext = (0, react.createContext)({});
      var tokens = __webpack_require__('./node_modules/@fluentui/tokens/lib/tokens.js');
      const useMarkListStyles = (0, makeStyles_esm.Z)({
        root: {
          listStyleType: 'none',
          display: 'grid',
          gridTemplateColumns: '1fr',
          rowGap: tokens.T.spacingHorizontalM,
        },
      });
      var jsx_runtime = __webpack_require__('./node_modules/react/jsx-runtime.js');
      const MarkList = ({ className, children, iconColor, iconName }) => {
        const classes = useMarkListStyles();
        return (0, jsx_runtime.jsx)(MarkListContext.Provider, {
          value: { iconColor, iconName },
      ...
      MarkList.displayName = 'MarkList';
      try {
        (MarkList.displayName = 'MarkList'),
          (MarkList.__docgenInfo = {
            description: '',
              ...
              iconColor: {
                ...
                type: {
                  ...
                  value: [
                    ...
                    { value: '"danger"' },
                    { value: '"info"' },
                    { value: '"accent-inverse"' },
                    { value: '"primary-inverse"' },
                    { value: '"secondary-inverse"' },
                    { value: '"tertiary-inverse"' },
                    { value: '"quaternary-inverse"' },
                    { value: '"negative-inverse"' },
                    { value: '"positive-inverse"' },
                    { value: '"warning-inverse"' },
                    { value: '"danger-inverse"' },
                    { value: '"info-inverse"' },
                  ],
                },
              },
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/mark-list/src/mark-list/mark-list.tsx#MarkList'
            ] = {
              docgenInfo: MarkList.__docgenInfo,
              name: 'MarkList',
              path: 'components/mark-list/src/mark-list/mark-list.tsx#MarkList',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      ...
      const useMarkListItemStyles = (0, makeStyles_esm.Z)({
          root: {
            display: 'grid',
            gridTemplateColumns: `${tokens.T.spacingHorizontalL} auto`,
            columnGap: tokens.T.spacingHorizontalM,
          },
          mark: { color: tokens.T.colorNeutralForeground4 },
        }),
        MarkListItem = ({ className, children }) => {
          const { iconColor, iconName } = (0, react.useContext)(MarkListContext),
            classes = useMarkListItemStyles(),
      ...
      try {
        (MarkListItem.displayName = 'MarkListItem'),
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/mark-list/src/mark-list-item/mark-list-item.tsx#MarkListItem'
            ] = {
              docgenInfo: MarkListItem.__docgenInfo,
              name: 'MarkListItem',
              path: 'components/mark-list/src/mark-list-item/mark-list-item.tsx#MarkListItem',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      const mark_list_stories = {
          title: 'Lists/MarkList',
          component: MarkList,
          argTypes: {
            iconName: { options: Object.keys(icons.H), control: { type: 'select' } },
            iconColor: {
              options: Object.keys(icon_styles.bG),
              control: { type: 'select' },
            },
          },
          decorators: [decorators.z],
        },
        ...
        Template = (args) =>
          (0, jsx_runtime.jsxs)(MarkList, {
            ...args,
            children: [
              (0, jsx_runtime.jsxs)(MarkListItem, {
                children: [
                  (0, jsx_runtime.jsxs)(text_text.x, {
                    as: 'span',
                    variant: 'caption',
                    children: ['Natural on every platform.', ' '],
                  }),
                  (0, jsx_runtime.jsx)(text_text.x, {
                    as: 'span',
                    color: 'secondary',
                    children:
                      'You want to know what to do. Your experiences should adapt to the device you’re on and should build off the familiar — designing for what you already understand. You want to know what to do. Your experiences should adapt to the device you’re on and should build off the familiar — designing for what you already understand.',
                  }),
                ],
              }),
              (0, jsx_runtime.jsxs)(MarkListItem, {
                children: [
                  (0, jsx_runtime.jsxs)(text_text.x, {
                    as: 'span',
                    variant: 'caption',
                    children: ['One for all, all for one. You want to be included.', ' '],
                  }),
                  (0, jsx_runtime.jsx)(text_text.x, {
                    as: 'span',
                    color: 'secondary',
                    children:
                      'Your experiences should consider, learn, and reflect a range of perspectives and abilities for the benefit of all.',
                  }),
                ],
              }),
              (0, jsx_runtime.jsxs)(MarkListItem, {
                children: [
                  (0, jsx_runtime.jsxs)(text_text.x, {
                    as: 'span',
                    variant: 'caption',
                    children: ['Built for focus. You want to stay in the flow.', ' '],
                  }),
                  (0, jsx_runtime.jsx)(text_text.x, {
                    as: 'span',
                    color: 'secondary',
                    children:
                      'Your experiences should inspire action, drawing you forward, simply and seamlessly.',
                  }),
                ],
              }),
              (0, jsx_runtime.jsxs)(MarkListItem, {
                children: [
                  (0, jsx_runtime.jsxs)(text_text.x, {
                    as: 'span',
                    variant: 'caption',
                    children: ['Unmistakably Microsoft.', ' '],
                  }),
                  (0, jsx_runtime.jsx)(text_text.x, {
                    as: 'span',
                    color: 'secondary',
                ...
                (0, jsx_runtime.jsx)(
                  MarkListItem,
                  {
                    children: (0, jsx_runtime.jsx)(text_text.x, {
                      ...
                      color: 'secondary',
                      children:
                        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam pulvinar commodo purus.',
                    }),
                  },
                  i,
                ),
      ...
      TemplateWithIcon.displayName = 'TemplateWithIcon';
      const Simple = Template.bind({});
      Simple.args = { iconName: void 0, iconColor: void 0 };
      const WithIcon = TemplateWithIcon.bind({});
      WithIcon.args = { iconName: 'check', iconColor: 'positive' };
      const __namedExportsOrder = ['Simple', 'WithIcon'];
    },
