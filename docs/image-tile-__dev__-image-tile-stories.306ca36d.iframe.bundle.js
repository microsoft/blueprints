...
(self.webpackChunkarbutus = self.webpackChunkarbutus || []).push([
  [1433],
  {
    ...
    './components/image-tile/__dev__/image-tile.stories.tsx': (
      ...
      const useImageTileStyles = (0,
      __webpack_require__('./node_modules/@griffel/react/makeStyles.esm.js').Z)({
        image: {
          width: '100%',
          height: 'auto',
          borderTopLeftRadius: tokens.T.borderRadiusLarge,
          borderTopRightRadius: tokens.T.borderRadiusLarge,
        },
      });
      var jsx_runtime = __webpack_require__('./node_modules/react/jsx-runtime.js');
      const ImageTile = ({
        ...
        return (0, jsx_runtime.jsxs)(tile.n, {
          ...
          children: [
            (0, jsx_runtime.jsx)(Image, {
              ...imageProps,
              className: (0, mergeClasses_esm.z)(classes.image, imageProps?.className),
            }),
            (title || description) &&
              (0, jsx_runtime.jsxs)('div', {
                className: (0, mergeClasses_esm.z)(space.px9, space.pb7, space.pt4),
                children: [
                  title &&
                    (0, jsx_runtime.jsx)(text_text.x, {
                      block: !0,
                      variant: 'caption',
                      className: description ? space.mb2 : '',
                      children: title,
                    }),
                  description &&
                    (0, jsx_runtime.jsx)(text_text.x, {
        ...
        (ImageTile.displayName = 'ImageTile'),
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/image-tile/src/image-tile/image-tile.tsx#ImageTile'
            ] = {
              docgenInfo: ImageTile.__docgenInfo,
              name: 'ImageTile',
              path: 'components/image-tile/src/image-tile/image-tile.tsx#ImageTile',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      const image_namespaceObject =
          __webpack_require__.p + 'static/media/image.0f52fefe.svg',
        image_tile_stories = {
        ...
        Template = (args) => (0, jsx_runtime.jsx)(ImageTile, { ...args });
      Template.displayName = 'Template';
      const Simple = Template.bind({});
      Simple.args = {
        title: 'InfoTip',
        description: 'A simple info tip lorem ipsum dolor sit amet, consectetur.',
        imageProps: { src: image_namespaceObject, alt: 'InfoTip graphic' },
      };
      ...
      const DescriptionOnly = Template.bind({});
      DescriptionOnly.args = {
        description: 'A simple info tip lorem ipsum dolor sit amet, consectetur.',
        imageProps: { src: image_namespaceObject, alt: 'InfoTip graphic' },
      };
      const __namedExportsOrder = ['Simple', 'TitleOnly', 'DescriptionOnly'];
    },
...
>>>>>>> 0a42c43 (Runs lint):docs/image-tile-__dev__-image-tile-stories.530e89cb.iframe.bundle.js
