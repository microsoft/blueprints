...
(self.webpackChunkarbutus = self.webpackChunkarbutus || []).push([
  [3550],
  {
    ...
    './components/ordered-list/__dev__/ordered-list.stories.tsx': (
      ...
      const injectIndex = ({ children, start }) => {
        ...
        (OrderedList.displayName = 'OrderedList'),
          (OrderedList.__docgenInfo = {
            ...
            props: {
              ...
              start: {
                ...
                description: 'Start value for the ordered list.',
                name: 'start',
                required: !1,
                type: { name: 'number' },
              },
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/ordered-list/src/ordered-list/ordered-list.tsx#OrderedList'
            ] = {
              docgenInfo: OrderedList.__docgenInfo,
              name: 'OrderedList',
              path: 'components/ordered-list/src/ordered-list/ordered-list.tsx#OrderedList',
            });
      ...
      try {
        (OrderedListItem.displayName = 'OrderedListItem'),
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/ordered-list/src/ordered-list-item/ordered-list-item.tsx#OrderedListItem'
            ] = {
              docgenInfo: OrderedListItem.__docgenInfo,
              name: 'OrderedListItem',
              path: 'components/ordered-list/src/ordered-list-item/ordered-list-item.tsx#OrderedListItem',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      const ordered_list_stories = { title: 'Lists/OrderedList', component: OrderedList },
        Template = (args) =>
          (0, jsx_runtime.jsxs)(OrderedList, {
            ...args,
            children: [
              (0, jsx_runtime.jsxs)(OrderedListItem, {
                children: [
                  ...
                  (0, jsx_runtime.jsx)(text_text.x, {
                    block: !0,
                    variant: 'description',
                    children: 'Description item one on the list.',
                  }),
                ],
              }),
              (0, jsx_runtime.jsxs)(OrderedListItem, {
                ...
                children: [
                  ...
                  (0, jsx_runtime.jsx)(text_text.x, {
                    block: !0,
                    variant: 'description',
                    children: 'Description item two on the list.',
                  }),
                ],
              }),
              (0, jsx_runtime.jsxs)(OrderedListItem, {
                ...
                children: [
                  ...
                  (0, jsx_runtime.jsx)(text_text.x, {
                    block: !0,
                    variant: 'description',
                    children: 'Description item three on the list.',
                  }),
                ],
              }),
            ],
