...
var PolishedError = (function (_Error) {
  ...
  function PolishedError2(code) {
    ...
    return (
      (_this =
        _Error.call(this, format.apply(void 0, [ERRORS[code]].concat(args))) || this),
...
You may have forgotten to import it.`);
    ...
    return function () {
      var args = arguments,
        styles =
          isReal && tag.__emotion_styles !== void 0 ? tag.__emotion_styles.slice(0) : [];
      if (
    ...
    lhs === rhs || !isObject(lhs) || !isObject(rhs)
      ...
      : Object.keys(lhs).reduce((acc, key) => {
          if (hasOwnProperty2(rhs, key)) {
            ...
            return (
              (isObject(difference) && isEmpty(difference)) || (acc[key] = difference),
              acc
            );
          }
