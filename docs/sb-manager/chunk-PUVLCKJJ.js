    ...
    (function () {
      ...
      function unstable_scheduleCallback(priorityLevel, callback, options) {
        ...
        if (typeof options == 'object' && options !== null) {
          ...
          (timeout = timeoutForPriorityLevel(priorityLevel)), (startTime = currentTime);
...
Check the render method of \`` +
      ...
      function accumulateOrCreateContinuousQueuedReplayableEvent(
        ...
        return (
          (existingQueuedEvent.eventSystemFlags |= eventSystemFlags), existingQueuedEvent
        );
      }
...
`,
      ...
      function createElement(type, props, rootContainerElement, parentNamespace) {
        ...
        if (
          ...
          if (
            ...
            ((domElement = ownerDocument.createElement(type)), type === 'select')
          ) {
            var node = domElement;
            props.multiple
              ? (node.multiple = !0)
      ...
      function getActiveElement(doc) {
        if (
          ((doc = doc || (typeof document < 'u' ? document : void 0)), typeof doc > 'u')
        )
          return null;
        try {
        ...
        EnterLeaveEventPlugin = {
          ...
          extractEvents: function (
            ...
            if (isOutEvent) {
              ...
              if (
                ((to = related ? getClosestInstanceFromNode(related) : null), to !== null)
              ) {
      ...
      function getMaskedContext(workInProgress2, unmaskedContext) {
        {
          ...
          return (
            instance && cacheContext(workInProgress2, unmaskedContext, context), context
          );
        }
      }
...
Learn more about this warning here: https://fb.me/react-legacy-context%s`,
      ...
      function readLazyComponentType(lazyComponent) {
        if (
          (initializeLazyComponentType(lazyComponent), lazyComponent._status !== Resolved)
        )
      ...
      function createUpdate(expirationTime, suspenseConfig) {
        ...
        return (
          (update.next = update), (update.priority = getCurrentPriorityLevel()), update
        );
      }
...
Incoming: %s`,
        ...
        InvalidNestedHooksDispatcherOnRerenderInDEV = null;
      {
        ...
        (HooksDispatcherOnMountInDEV = {
          ...
          (HooksDispatcherOnMountWithHookTypesInDEV = {
            ...
            useDebugValue: function (value, formatterFn) {
              return (
                (currentHookNameInDev = 'useDebugValue'), updateHookTypesDev(), void 0
              );
            },
            useResponder: function (responder, props) {
              return (
      ...
      function updateHostText(current2, workInProgress2) {
        return (
          current2 === null && tryToClaimNextHydratableInstance(workInProgress2), null
        );
      }
...
Check the render method of \`` +
      ...
      function validateRevealOrder(revealOrder) {
        if (
          ...
          if (
            ((didWarnAboutRevealOrder[revealOrder] = !0), typeof revealOrder == 'string')
          )
        ...
        switch (workInProgress2.tag) {
          ...
          case SuspenseComponent: {
            ...
            if ((workInProgress2.effectTag & DidCapture) !== NoEffect)
              return (
                (workInProgress2.expirationTime = renderExpirationTime2), workInProgress2
              );
            ...
            return (
              (nextDidTimeout || prevDidTimeout) && (workInProgress2.effectTag |= Update),
              null
            );
          }
          case HostPortal:
          ...
          case HostRoot: {
            {
              ...
              _root.hydrate &&
                ((_root.hydrate = !1), commitHydratedContainer(_root.containerInfo));
            }
            return;
          }
          case Profiler:
...
Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.` +
      ...
      function performConcurrentWorkOnRoot(root2, didTimeout) {
        if (((currentEventTime = NoWork), didTimeout)) {
          var currentTime = requestCurrentTimeForUpdate();
          return (
            markRootExpiredAtTime(root2, currentTime), ensureRootIsScheduled(root2), null
          );
        }
        var expirationTime = getNextRootExpirationTimeToWorkOn(root2);
        if (expirationTime !== NoWork) {
          ...
          if (
            ...
            if (
              (ensureRootIsScheduled(root2), root2.callbackNode === originalCallbackNode)
            )
...
Check the render method of %s.`,
        ...
        setSuspenseHandler = null;
      {
        var copyWithSetImpl = function (obj, path, idx, value) {
            ...
            return (
              (updated[key] = copyWithSetImpl(obj[key], path, idx + 1, value)), updated
            );
          },
      ...
      function createRootImpl(container, tag, options) {
        ...
        if (
          (markContainerAsRoot(root2.current, container), hydrate2 && tag !== LegacyRoot)
        ) {
          var doc =
...
function getBoundingClientRect(element, includeScale, isFixedStrategy) {
  ...
  includeScale &&
    ...
    (scaleY =
      (element.offsetHeight > 0 && round(clientRect.height) / element.offsetHeight) ||
      1));
...
function mapToStyles(_ref2) {
  ...
  var commonStyles = Object.assign({ position }, adaptive && unsetSides),
    _ref4 =
      roundOffsets === !0 ? roundOffsetsByDPR({ x, y }, getWindow(popper2)) : { x, y };
...
function offset(_ref2) {
  var state = _ref2.state,
    ...
    data = placements.reduce(function (acc, placement) {
      return (
        (acc[placement] = distanceAndSkiddingToXY(placement, state.rects, offset2)), acc
      );
    }, {}),
