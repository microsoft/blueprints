            ...
            EASING = (function () {
              ...
              return {
                ...
                easeInBack: function (x, t, b, c, d, s) {
                  return (
                    (s = s || _easingsMath.o), c * (t /= d) * t * ((s + 1) * t - s) + b
                  );
                },
            ...
            FRAMEWORK = (function () {
              ...
              function each(obj, callback) {
                ...
                if (isArrayLike(obj))
                  for (
                    ;
                    i < obj[LEXICON.l] && callback.call(obj[i], i, obj[i]) !== !1;
                    i++
                  );
                      ...
                      (timeStart = COMPATIBILITY.now()),
                        (frame = function () {
                          (timeNow = COMPATIBILITY.now()),
                            ...
                            (percent =
                              1 -
                              (MATH.max(0, timeStart + duration - timeNow) / duration ||
                                0));
                          for (key in to)
                ...
                (FakejQuery[LEXICON.p] = {
                  ...
                  offset: function () {
                    var el = this[0],
                      rect = el[LEXICON.bCR](),
                      scrollLeft =
                        window2.pageXOffset || document.documentElement[_strScrollLeft],
                      scrollTop =
                        window2.pageYOffset || document.documentElement[_strScrollTop];
                        ...
                        checkObjectProps = function (
                          ...
                          for (var prop in template2)
                            if (template2[LEXICON.hOP](prop) && data[LEXICON.hOP](prop)) {
                              ...
                              if (
                                ((dataDiffValue =
                                  dataDiffValue === undefined2 ? {} : dataDiffValue),
              ...
              function OverlayScrollbarsInstance(
                        ...
                        (elem = check._elem),
                          elem &&
                            each(check._attrs, function (index2, attr) {
                              (curr =
                                attr.charAt(0) === ':' ? elem.is(attr) : elem.attr(attr)),
                        ...
                        setOverflowVariables = function (horizontal) {
                          ...
                          (overflowBehaviorIsVS[xy] = overflowBehavior[xy] === 'v-s'),
                            ...
                            (overflowAmount[xy] = MATH.max(
                              0,
                              MATH.round(
                                (contentScrollSize[wh] - _viewportSize[wh]) * 100,
                              ) / 100,
                            )),
                            (overflowAmount[xy] *=
                    ...
                    if (_initialized) {
                      ...
                      extensionOnName.substr(0, 2) === 'on' &&
                        ...
                        each(_extensions, function () {
                          (ext = this),
                            type(ext.on) == TYPES.f && ext.on(extensionOnName, args);
                        });
                ...
                function isHTMLElement(o) {
                  var strOwnerDocument = 'ownerDocument',
                    ...
                    wnd =
                      (o && o[strOwnerDocument] && o[strOwnerDocument].parentWindow) ||
                      window2;
                          ...
                          ? (rawScroll[strLength] > 2 &&
                            ...
                            (rawScroll = rawScroll[strReplace](/min/g, 0)
                              ...
                              [strReplace](
                                ...
                                mult +
                                  (maxScroll *
                                    (isRTLisX && _rtlScrollBehavior.n ? -1 : 1)) /
                                    100,
                              )
