    ...
    './components/tile/__dev__/tile.stories.tsx': (
      ...
      __webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          ...
          SolidColorVariant: () => SolidColorVariant,
          __namedExportsOrder: () => __namedExportsOrder,
          default: () => tile_stories,
        });
      ...
      const isImage = ({ variant }) => 'image' === variant,
        Tile = ({
          children,
          variant,
          as: Root = 'div',
      ...
      try {
        (Tile.displayName = 'Tile'),
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES['components/tile/src/tile.tsx#Tile'] = {
              docgenInfo: Tile.__docgenInfo,
              name: 'Tile',
              path: 'components/tile/src/tile.tsx#Tile',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      const background_namespaceObject =
          __webpack_require__.p + 'static/media/background.0b6922ce.png',
        logo_namespaceObject = __webpack_require__.p + 'static/media/logo.06277550.svg',
        tile_stories = {
          title: 'Atoms/Tile',
          component: Tile,
          argTypes: {
        ...
        useGridStyles = (0, makeStyles_esm.Z)({
          root: {
            width: '100%',
            maxWidth: '60rem',
            display: 'grid',
          ...
          single: { gridTemplateColumns: '1fr', columnGap: '1rem' },
          double: { gridTemplateColumns: 'repeat(2, 1fr)', columnGap: '1rem' },
          triple: {
          ...
          imageButton: {
            backgroundColor: tokens.T.colorNeutralBackground1,
            height: '2rem',
            ...index_esm.q5.borderRadius('2rem'),
            alignItems: 'center',
            gridTemplateColumns: 'repeat(2, 1fr)',
            paddingTop: '0.125rem',
          },
          image: { backgroundPositionY: '70%' },
        }),
        Children = () => {
            ...
            children: [
              ...
              (0, jsx_runtime.jsxs)('p', {
                children: [
                  ...
                  ' ',
                  (0, jsx_runtime.jsx)('strong', { children: 'Laboriosam' }),
                  ' deleniti eius quam? Occupy tacos schlitz flexitarian. Ennui palo santo fingerstache sriracha, distillery shabby chic bitters craft beer kinfolk.',
                ],
              }),
              (0, jsx_runtime.jsxs)('ul', {
                children: [
                  (0, jsx_runtime.jsx)('li', { children: 'One' }),
                  (0, jsx_runtime.jsx)('li', { children: 'Two' }),
                  (0, jsx_runtime.jsx)('li', { children: 'Three' }),
                ],
              }),
            ],
          });
      ...
      const Template = (args) => {
        ...
        return (0, jsx_runtime.jsxs)('div', {
          className: (0, mergeClasses_esm.z)(classes.root, classes.double),
          children: [
            (0, jsx_runtime.jsx)(Tile, {
              ...args,
              children: (0, jsx_runtime.jsx)(Children, {}),
            }),
            (0, jsx_runtime.jsx)(Tile, {
              ...args,
              children: (0, jsx_runtime.jsx)(Children, {}),
      ...
      const CardVariant = Template.bind({});
      CardVariant.args = { variant: 'card' };
      const ImageTemplate = (args) => {
        const classes = useGridStyles(),
          space = (0, use_space_styles.z)();
        return (0, jsx_runtime.jsx)('div', {
          className: (0, mergeClasses_esm.z)(classes.root, classes.single),
          children: (0, jsx_runtime.jsx)(Tile, {
            ...args,
            className: (0, mergeClasses_esm.z)(classes.tile, classes.image),
            children: (0, jsx_runtime.jsxs)('div', {
              className: (0, mergeClasses_esm.z)(classes.imageContent, space.px6),
              children: [
                ...
                (0, jsx_runtime.jsx)('div', {
                  className: (0, mergeClasses_esm.z)(classes.imageButton, space.px3),
      ...
      const ImageVariant = ImageTemplate.bind({});
      ImageVariant.args = { variant: 'image', imageSrc: background_namespaceObject };
      const SolidColorVariant = Template.bind({});
      ...
      const InteractiveTemplate = () => {
        ...
        return (0, jsx_runtime.jsxs)('div', {
          className: (0, mergeClasses_esm.z)(classes.root, classes.triple),
          children: [
            (0, jsx_runtime.jsxs)(Tile, {
              as: 'button',
              variant: 'card',
              onClick,
              className: (0, mergeClasses_esm.z)(classes.tile, space.p6),
              children: [
                (0, jsx_runtime.jsx)(text_text.x, {
                  variant: 'caption',
                  className: space.mb2,
                ...
                (0, jsx_runtime.jsx)(text_text.x, {
                  children:
                    'Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis asperiores, repellendus esse labore dolore cupiditate veritatis non qui ut dolores.',
                }),
              ],
            }),
            (0, jsx_runtime.jsx)(Tile, {
              as: 'button',
              variant: 'image',
              imageSrc: background_namespaceObject,
              onClick,
              className: (0, mergeClasses_esm.z)(classes.tile, space.p6),
              children: (0, jsx_runtime.jsx)(text_text.x, {
                variant: 'jumbo',
      ...
      InteractiveTemplate.displayName = 'InteractiveTemplate';
      const InteractiveVariant = InteractiveTemplate.bind({}),
        __namedExportsOrder = [
          'CardVariant',
          'ImageVariant',
          'SolidColorVariant',
...
>>>>>>> 0a42c43 (Runs lint):docs/tile-__dev__-tile-stories.fc1dd662.iframe.bundle.js
