    ...
    './components/heading/__dev__/heading.stories.tsx': (
      ...
      __webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          Simple: () => Simple,
          WithCopyLinkButton: () => WithCopyLinkButton,
          __namedExportsOrder: () => __namedExportsOrder,
          default: () => heading_stories,
        });
      var text_styles = __webpack_require__('./components/text/lib/text/text.styles.js'),
      ...
      const Heading = ({
        ...
        const { copy, status } = (0, use_copy_to_clipboard.m)();
        return (
          (0, react.useEffect)(() => {
            'success' === status && headingUrl && onCopy?.({ url: headingUrl });
        ...
        (Heading.displayName = 'Heading'),
          (Heading.__docgenInfo = {
            ...
            props: {
              ...
              headingUrl: {
                defaultValue: null,
                description: 'Link to the heading section.',
                name: 'headingUrl',
                required: !1,
                type: { name: 'string' },
              },
              copyLabel: {
                defaultValue: { value: 'Copy heading URL to clipboard.' },
                description:
              ...
              onCopy: {
                ...
                required: !1,
                type: {
                  name: '((args0: OnCopyArgs) => void) | ((args0: OnCopyArgs) => void)',
                },
              },
            },
          }),
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/heading/src/heading/heading.tsx#Heading'
            ] = {
              docgenInfo: Heading.__docgenInfo,
              name: 'Heading',
              path: 'components/heading/src/heading/heading.tsx#Heading',
            });
      ...
      const heading_stories = {
          ...
          argTypes: {
            variant: {
              options: Object.keys(text_styles.AD),
              control: { type: 'select' },
            },
            color: { options: Object.keys(text_styles.bG), control: { type: 'select' } },
          },
        },
        Template = (args) => {
          const [copied, setCopied] = (0, react.useState)(!1),
            [headingUrl, setHeadingUrl] = (0, react.useState)(''),
          ...
          return (0, jsx_runtime.jsxs)(jsx_runtime.Fragment, {
            children: [
              (0, jsx_runtime.jsx)(Heading, { ...args, onCopy }),
              copied &&
                (0, jsx_runtime.jsxs)(text_text.x, {
                  variant: 'caption',
                  color: 'positive',
                  children: ['Copied ', headingUrl, '#', args.id],
                }),
            ],
          });
        },
        Simple = Template.bind({});
      Simple.args = {
        as: 'h1',
        children: 'Heading',
        color: 'primary',
      ...
      const WithCopyLinkButton = Template.bind({});
      ...
      const __namedExportsOrder = ['Simple', 'WithCopyLinkButton'];
    },
    './components/icon-button/lib/icon-button/icon-button.js': (
      __unused_webpack_module,
      __webpack_exports__,
