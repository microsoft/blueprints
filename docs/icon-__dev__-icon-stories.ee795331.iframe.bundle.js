  ...
  [6349],
  {
    ...
    './components/icon/__dev__/icon.stories.tsx': (
      ...
      const colorMap = {
          ...
          'accent-inverse': tokens.T.colorBrandBackground,
          'primary-inverse': tokens.T.colorNeutralBackground1,
          'secondary-inverse': tokens.T.colorNeutralBackground2,
          'tertiary-inverse': tokens.T.colorNeutralBackground3,
          'quaternary-inverse': tokens.T.colorNeutralBackground4,
          'negative-inverse': tokens.T.colorPaletteDarkOrangeBackground1,
          'positive-inverse': tokens.T.colorPaletteGreenBackground1,
          'warning-inverse': tokens.T.colorPaletteMarigoldBackground1,
          'danger-inverse': tokens.T.colorPaletteDarkOrangeBackground1,
          'info-inverse': tokens.T.colorBrandBackground2,
        },
        colorClasses = (0, map_to_styles.f)(colorMap, (color) => ({ color })),
        sizeClasses = {
          small: { height: tokens.T.spacingVerticalM },
          medium: { height: tokens.T.spacingVerticalL },
          large: { height: tokens.T.spacingVerticalXL },
        },
      ...
      const paths = {
        ...
        Icon = ({
          ...
          const Icon = (0, react.useMemo)(() => paths[iconName], [iconName]),
            a11yId = (0, react.useId)(),
            a11yProps = {};
          label
          ...
          return (0, jsx_runtime.jsxs)('svg', {
            ...
            ...a11yProps,
            children: [
              label && (0, jsx_runtime.jsx)('title', { id: a11yId, children: label }),
      ...
      try {
        (Icon.displayName = 'Icon'),
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES['components/icon/src/icon/icon.tsx#Icon'] = {
              docgenInfo: Icon.__docgenInfo,
              name: 'Icon',
              path: 'components/icon/src/icon/icon.tsx#Icon',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      const icon_stories = {
          title: 'Atoms/Icon',
          ...
          argTypes: {
            ...
            iconName: { options: Object.keys(paths), control: { type: 'select' } },
            size: { options: Object.keys(sizeClasses), control: { type: 'select' } },
          },
          decorators: [
            (Story) =>
        ...
        useGridStyles = (0, makeStyles_esm.Z)({
          ...
          swatch: {
            ...
            ...index_esm.q5.borderRadius('0.25rem'),
          },
        ...
        Template = (args) => {
          ...
          return (0, jsx_runtime.jsx)('div', {
            className: (0, mergeClasses_esm.z)(classes.root, space.p4),
            children: Object.keys(paths).map((iconName, i) =>
              (0, jsx_runtime.jsxs)(
                'div',
                {
                  ...
                  children: [
                    (0, jsx_runtime.jsx)('div', {
                      ...
                      children: (0, jsx_runtime.jsx)(Icon, { ...args, iconName }),
                    }),
      ...
      Simple.args = { iconName: 'exclamation', size: 'medium', color: 'primary' };
