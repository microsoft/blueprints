...
(self.webpackChunkarbutus = self.webpackChunkarbutus || []).push([
  [4648],
  {
    ...
    './components/badge/lib/badge/badge.js': (
      __unused_webpack_module,
      __webpack_exports__,
      __webpack_require__,
    ) => {
      ...
      const colorMap = {
        ...
        Badge = ({ className, iconName, color = 'primary', isInline }) => {
    ...
    './components/callout/__dev__/callout.stories.tsx': (
      ...
      const colorMap = {
          ...
          info: {
            background: tokens.T.colorNeutralBackground2,
            stroke: tokens.T.colorNeutralStroke2,
          },
          accent: {
            background: tokens.T.colorBrandBackground2,
            stroke: tokens.T.colorBrandStroke2,
          },
        },
        statusClasses = (0, map_to_styles.f)(colorMap, ({ background, stroke }) => ({
          backgroundColor: background,
          ...index_esm.q5.borderColor(stroke),
        })),
        useCalloutStyles = (0, makeStyles_esm.Z)({
          root: {
            color: tokens.T.colorNeutralForeground1,
            display: 'grid',
            gridTemplateColumns: `${tokens.T.spacingVerticalXXL} auto`,
      ...
      var mergeClasses_esm = __webpack_require__(
        ...
        badge = __webpack_require__('./components/badge/lib/badge/badge.js'),
        jsx_runtime = __webpack_require__('./node_modules/react/jsx-runtime.js');
      const CalloutBadge = ({ status, className }) => {
        switch (status) {
          case 'success':
            return (0, jsx_runtime.jsx)(badge.C, {
              color: 'positive',
              iconName: 'check',
              className,
            });
      ...
      try {
        (CalloutBadge.displayName = 'CalloutBadge'),
          (CalloutBadge.__docgenInfo = {
            description: '',
            displayName: 'CalloutBadge',
            props: {
              className: {
                defaultValue: null,
              ...
              status: {
                defaultValue: null,
                description: 'Status color variant options.',
                name: 'status',
                required: !1,
                type: {
                  name: 'enum',
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/callout/src/callout-badge/callout-badge.tsx#CalloutBadge'
            ] = {
              docgenInfo: CalloutBadge.__docgenInfo,
              name: 'CalloutBadge',
              path: 'components/callout/src/callout-badge/callout-badge.tsx#CalloutBadge',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      const Callout = ({ status = 'info', title, children }) => {
        const classes = useCalloutStyles(),
          space = (0, use_space_styles.z)();
        return (0, jsx_runtime.jsxs)('div', {
          className: (0, mergeClasses_esm.z)(classes.root, space.p7, classes[status]),
          children: [
            (0, jsx_runtime.jsx)(CalloutBadge, { status }),
        ...
        (Callout.displayName = 'Callout'),
          (Callout.__docgenInfo = {
            ...
            props: {
              ...
              title: {
                defaultValue: null,
                description: 'String that renders as the Header text.',
                name: 'title',
                required: !0,
                type: { name: 'string' },
              },
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              'components/callout/src/callout/callout.tsx#Callout'
            ] = {
              docgenInfo: Callout.__docgenInfo,
              name: 'Callout',
              path: 'components/callout/src/callout/callout.tsx#Callout',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      const callout_stories = {
          title: 'Blocks/Callout',
          component: Callout,
          argTypes: {
            status: { options: Object.keys(colorMap), control: { type: 'select' } },
          },
        },
        Template = (args) =>
      ...
      Simple.args = { title: 'Simple Callout Example', status: 'success' };
