/*! For license information please see 7992.96daf9e5.iframe.bundle.js.LICENSE.txt */
'use strict';
(self.webpackChunkarbutus = self.webpackChunkarbutus || []).push([
  [7992],
  {
    ...
    './node_modules/@codesandbox/sandpack-client/dist/index-bd1ff004.mjs': (
      ...
      var _types_36e5ec0d_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          './node_modules/@codesandbox/sandpack-client/dist/types-36e5ec0d.mjs',
        ),
        static_browser_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          './node_modules/static-browser-server/out/lib/main.js',
        ),
        _base_80a1f760_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          './node_modules/@codesandbox/sandpack-client/dist/base-80a1f760.mjs',
        ),
        _client_utils_7a723432_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          './node_modules/@codesandbox/sandpack-client/dist/client.utils-7a723432.mjs',
        ),
        readBuffer =
        ...
        SandpackStatic = (function (_super) {
          function SandpackStatic(selector, sandboxSetup, options) {
            ...
            if (
              ...
              (_this.emitter =
                new _client_utils_7a723432_mjs__WEBPACK_IMPORTED_MODULE_4__.E()),
              (_this.previewController =
                new static_browser_server__WEBPACK_IMPORTED_MODULE_0__.PreviewController({
                  baseUrl:
                    null !== (_a = options.bundlerURL) && void 0 !== _a
                      ? _a
          ...
          return (
            (0, _types_36e5ec0d_mjs__WEBPACK_IMPORTED_MODULE_3__.g)(
              SandpackStatic,
              _super,
            ),
            (SandpackStatic.prototype.injectContentIntoHead = function (
              content,
              contentToInsert,
            ) {
              var _a;
              return (content =
                null !==
                  (_a = (function (regex, content, insertable) {
            ...
            (SandpackStatic.prototype.injectExternalResources = function (
              content,
              externalResources,
            ) {
              void 0 === externalResources && (externalResources = []);
              var tagsToInsert = externalResources
                .map(function (resource) {
                  var match = resource.match(/\.([^.]*)$/),
                    fileType = null == match ? void 0 : match[1];
                  if ('css' === fileType || resource.includes('fonts.googleapis'))
            ...
            (SandpackStatic.prototype.updateSandbox = function (
              setup,
              _isInitializationCompile,
            ) {
              void 0 === setup && (setup = this.sandboxSetup);
              var modules = (0,
              _client_utils_7a723432_mjs__WEBPACK_IMPORTED_MODULE_4__.f)(setup.files);
              this.dispatch({
                codesandbox: !0,
                modules,
            ...
            (SandpackStatic.prototype.compile = function (files) {
              return (0, _types_36e5ec0d_mjs__WEBPACK_IMPORTED_MODULE_3__._)(
                this,
                void 0,
                void 0,
                function () {
                  var previewUrl;
                  return (0, _types_36e5ec0d_mjs__WEBPACK_IMPORTED_MODULE_3__.a)(
                    this,
                    function (_a) {
                      switch (_a.label) {
                        case 0:
            ...
            (SandpackStatic.prototype.dispatch = function (message) {
              var _a;
              if ('compile' === message.type) this.compile(message.modules);
              else
    ...
    './node_modules/static-browser-server/out/lib/main.js': (module) => {
      var mod,
      ...
      var import_mime_db = ((mod, isNodeMode, target) => (
      ...
      for (const [mimetype, entry] of entries) {
        ...
        if (extensions?.length)
          for (const ext of extensions) extensionMap.set(ext, mimetype);
      }
      ...
      var PreviewController = class {
        ...
        async handleWorkerRequest(request) {
          ...
          try {
            ...
            if (!headers['Content-Type']) {
              ...
              foundMimetype && (headers['Content-Type'] = foundMimetype);
            }
        ...
        getRelayUrl(previewUrl) {
          ...
          return (relayUrl.pathname = '/__csb_relay/'), relayUrl.toString();
        }
        async _initPreview() {
          const id = (function generateRandomId() {
              return (+`${Date.now()}${Math.round(
                1e4 * Math.random(),
              )}${(counter += 1)}`).toString(16);
            })(),
            previewUrl = new URL(this.baseUrl);
          ...
          return new Promise((resolve) => {
            ...
            (port.onmessage = (evt) => {
              if ('object' == typeof evt.data && '$CSB_RELAY' === evt.data.$channel)
              ...
              (iframe.onload = () => {
                const initMsg = { $channel: '$CSB_RELAY', $type: 'preview/init' };
