try {
    ...
    _y = (e, t, r, n) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let a of wy(t))
          !Ty.call(e, a) &&
            a !== r &&
            ha(e, a, { get: () => t[a], enumerable: !(n = Sy(t, a)) || n.enumerable });
      return e;
    };
  var fe = (e, t, r) => (
    (r = e != null ? Fy(By(e)) : {}),
  ...
  var Ms = F((iM, js) => {
    ...
    function Lb(e, t) {
      var r = this.__data__;
      return (
        (this.size += this.has(e) ? 0 : 1), (r[e] = Mb && t === void 0 ? qb : t), this
      );
    }
    js.exports = Lb;
  });
  ...
  var zs = F((gM, Us) => {
    ...
    function Kb() {
      (this.size = 0),
        (this.__data__ = { hash: new $s(), map: new (Vb || Wb)(), string: new $s() });
    }
    Us.exports = Kb;
  });
  var Gs = F((AM, Hs) => {
  ...
  var Pc = F((oU, Rc) => {
    ...
    function vv(e, t, r, n, a, o) {
      ...
      if (g && !y)
        return (
          o || (o = new Do()), u || Av(e) ? mv(e, t, r, n, a, o) : yv(e, t, s, r, n, a, o)
        );
      if (!(r & Ev)) {
  ...
  var mp = F((wz, gp) => {
    ...
    function BC(e, t, r) {
      ...
      return o || ++n != a
        ? o
        : ((a = e == null ? 0 : e.length), !!a && SC(a) && FC(u, a) && (xC(e) || CC(e)));
    }
    gp.exports = BC;
  });
  var So = F((Oz, yp) => {
            ...
            function (n, a, o) {
              ...
              a.exports = function (y) {
                ...
                return function (h) {
                  ...
                  return (
                    (E.limit = y), (E.wasMemoized = !1), (E.cache = A), (E.lru = g), E
                  );
                };
              };
              function i(y, A) {
  ...
  var In = F((vY, L0) => {
    ...
    re.prototype = {
      then: function (e, t) {
        ...
        return (
          this._continuations.push({ promise: t, catchFn: e }), this._runRejections(), t
        );
      },
      finally: function (e) {
        var t = !1;
    ...
    var tu = function () {
      ...
      vt = {
        ...
        '%MapIteratorPrototype%':
          typeof Map > 'u' || !Gt || !Ee ? ee : Ee(new Map()[Symbol.iterator]()),
        '%Math%': Math,
        '%Number%': Number,
        '%Object%': Object,
        ...
        '%SetIteratorPrototype%':
          typeof Set > 'u' || !Gt || !Ee ? ee : Ee(new Set()[Symbol.iterator]()),
      ...
      for (var y = 1, A = !0; y < n.length; y += 1) {
        ...
        if (
          ...
          if (Dt && y + 1 >= n.length) {
            var b = Dt(i, g);
            (A = !!b),
              A && 'get' in b && !('originalValue' in b.get) ? (i = b.get) : (i = i[g]);
          } else (A = Ln(i, g)), (i = i[g]);
          A && !s && (vt[u] = i);
        }
      }
  ...
  var Ah = F((PX, zn) => {
    ...
    zn.exports = function (t) {
      ...
      if (hh && Ct) {
        var n = hh(r, 'length');
        n.configurable &&
          Ct(r, 'length', { value: 1 + sT(0, t.length - (arguments.length - 1)) });
      }
      return r;
    };
    var gh = function () {
  ...
  var Hh = F((WX, zh) => {
    ...
    zh.exports = function e(t, r, n, a) {
      ...
      if (PT(t)) {
        for (
          var x = '<' + Bh.call(String(t.nodeName)), S = t.attributes || [], P = 0;
          P < S.length;
          P++
        )
...
` +
    ...
    var XT = Yn(),
      ...
      t8 = function (t, r, n, a, o) {
        ...
        for (var i = '', s = 0; s < u.length; ++s) {
          ...
          if (d < 55296 || d >= 57344) {
            i =
              i + (Ve[224 | (d >> 12)] + Ve[128 | ((d >> 6) & 63)] + Ve[128 | (d & 63)]);
            continue;
          }
          (s += 1),
    ...
    var Qh = Wh(),
      ...
      d8 = function (t) {
        ...
        if (typeof t.format < 'u') {
          if (!i8.call(Mr.formatters, t.format))
        ...
        return (
          ...
          {
            addQueryPrefix:
              typeof t.addQueryPrefix == 'boolean' ? t.addQueryPrefix : we.addQueryPrefix,
            ...
            formatter: a,
            serializeDate:
              typeof t.serializeDate == 'function' ? t.serializeDate : we.serializeDate,
    ...
    var Qt = Au(),
      ...
      y8 = function (t, r) {
        ...
        if (r.charsetSentinel)
          for (s = 0; s < u.length; ++s)
            u[s].indexOf('utf8=') === 0 &&
              (u[s] === m8 ? (d = 'utf-8') : u[s] === g8 && (d = 'iso-8859-1'),
              (i = s),
              (s = u.length));
        for (s = 0; s < u.length; ++s)
          if (s !== i) {
      ...
      A8 = function (t, r, n, a) {
        if (t) {
          var o = n.allowDots ? t.replace(/\.([^.[]+)/g, '[$1]') : t,
            ...
            y = [];
          if (d) {
            if (!n.plainObjects && Du.call(Object.prototype, d) && !n.allowPrototypes)
              return;
            y.push(d);
          }
      ...
      E8 = function (t) {
        ...
        return {
          ...
          parameterLimit:
            typeof t.parameterLimit == 'number' ? t.parameterLimit : De.parameterLimit,
  ...
  var kg = F((TZ, Ig) => {
    ...
    (function () {
      ...
      function i(g) {
        var h, E, b;
        if (g.length === 0 || ((b = g.charCodeAt(0)), !e.isIdentifierStartES5(b)))
          return !1;
      ...
      function d(g) {
        ...
        for (S = e.isIdentifierStartES6, h = 0, E = g.length; h < E; ++h) {
          if (((b = g.charCodeAt(h)), 55296 <= b && b <= 56319)) {
            if ((++h, h >= E || ((x = g.charCodeAt(h)), !(56320 <= x && x <= 57343))))
              return !1;
            b = s(b, x);
          }
          if (!S(b)) return !1;
...
`;
      ...
      function P() {
        ...
        if (((B = ''), (R = r.charCodeAt(a)), R !== 46)) {
          if (((B = b()), (R = r.charCodeAt(a)), B === '0')) {
            if (R === 120 || R === 88) {
              for (B += b(); a < n && ((R = r.charCodeAt(a)), !!s.code.isHexDigit(R)); )
                B += b();
              return (
            ...
            if (s.code.isOctalDigit(R)) {
              for (B += b(); a < n && ((R = r.charCodeAt(a)), !!s.code.isOctalDigit(R)); )
                B += b();
              return (
                a < n &&
                  ((R = r.charCodeAt(a)),
        ...
        if (R === 46)
          for (B += b(); a < n && ((R = r.charCodeAt(a)), !!s.code.isDecimalDigit(R)); )
            B += b();
        if (R === 101 || R === 69)
          if (
            ((B += b()),
      ...
      function ie() {
        var B,
          R = a - 1,
          k;
        if ((w(t.LBRACE, 'RecordType should start with {'), (B = []), u === t.COMMA))
          w(t.COMMA);
      ...
      function Y() {
        ...
        switch (u) {
          ...
          case t.NAME:
            ...
            if (i === 'true' || i === 'false')
              return (
                w(t.NAME), E({ type: e.BooleanLiteralType, value: i === 'true' }, [R, o])
              );
          ...
          case t.NUMBER:
            return (
              $(), E({ type: e.NumericLiteralType, value: i }, [o - String(i).length, o])
            );
          default:
            d.throwError('unexpected token');
        }
...
\u2028\u2029])`;
      ...
      (function (w) {
        ...
        function K(k) {
          var _;
          if (!n.code.isIdentifierStartES5(z.charCodeAt(I)) && !z[I].match(/[0-9]/))
            return null;
        ...
        (J.prototype.addError = function (_) {
          ...
          (J.prototype.parseDescription = function () {
            ...
            return (
              _ && (/^-\s+/.test(_) && (_ = _.substring(2)), (this._tag.description = _)),
              !0
            );
          }),
      ...
      (nr = function (e, t, r) {
        ...
        (Gg = function (e) {
          ...
          return {
            h: ve(e.h),
            s: ve(
              a > 0 && a < 200 ? ((t * r) / 100 / (a <= 100 ? a : 200 - a)) * 100 : 0,
            ),
            l: ve(a / 2),
            a: ve(n, 2),
          };
  ...
  var Lu = F((gee, sm) => {
    ...
    W.rgb.ansi16 = function (e, t = null) {
      ...
      let u =
        30 +
        ((Math.round(a / 255) << 2) | (Math.round(n / 255) << 1) | Math.round(r / 255));
      return o === 2 && (u += 60), u;
    };
  ...
  var cm = F((Aee, lm) => {
    ...
    function a4(e, t) {
      let r = [t[e].parent, e],
        ...
        a = t[e].parent;
      for (; t[a].parent; )
        r.unshift(t[a].parent), (n = n4(oa[t[a].parent][a], n)), (a = t[a].parent);
        ...
        (K4 = (e, t, r) => {
          ...
          let o = rt(
            ...
            u = ge(
              (i) => {
                i?.valid &&
                  (o.some((s) => sa(s[r]) === sa(i[r])) || a((s) => s.concat(i)));
              },
              [r, o],
            );
  ...
  function Ot(e) {
    ...
    if (o)
      return {
        ...
        alpha:
          parseFloat('' + o[4]) > 1 ? parseFloat('' + o[4]) / 100 : parseFloat('' + o[4]),
      };
    var u = T2.exec(t);
    if (u) {
    ...
    if (g) {
      ...
      return {
        ...
        alpha:
          parseFloat('' + g[4]) > 1 ? parseFloat('' + g[4]) / 100 : parseFloat('' + g[4]),
      };
    }
    throw new Oe(5);
  }
    ...
    eF = (e, t, r, n) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let a of Xx(t))
          !Qx.call(e, a) &&
            a !== r &&
            Wp(e, a, { get: () => t[a], enumerable: !(n = Yx(t, a)) || n.enumerable });
      return e;
    },
    tF = (e, t, r) => (
      (r = e != null ? Kx(Jx(e)) : {}),
              ...
              switch (h.slice(8, -1)) {
                ...
                case 'Array':
                  ...
                  for (g = 0; g < i.length; g++)
                    if ((g in i || g in s) && (g in i != g in s || !u(i[g], s[g], d)))
                      return !1;
                  return !0;
                case 'Object':
                  return u(r(i), r(s), d);
    ...
    let u = [],
      ...
      s = {
        ...
        gfmTask: {
          ...
          h: (h, E, b) =>
            n('input', { checked: h.T, key: b.k, readOnly: !0, type: 'checkbox' }),
        },
        heading: {
          t: et(ad),
          i: te.HIGH,
...
`,
        ...
        refImage: {
          ...
          h: (h, E, b) =>
            n('img', { key: b.k, alt: h.D, src: Ut(i[h.F].R), title: i[h.F].N }),
        },
        refLink: {
          t: it(TF),
          i: te.MAX,
    ...
    w3 = (e, t, r, n) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let a of Xf(t))
          !S3.call(e, a) &&
            a !== r &&
            Yf(e, a, { get: () => t[a], enumerable: !(n = x3(t, a)) || n.enumerable });
      return e;
    },
    Jf = (e, t, r) => (
      (r = e != null ? C3(F3(e)) : {}),
      ...
      return d
        ? i.concat(
            d.map(function (y) {
              var A, g;
              return (g =
                (A = y.match(/[\t ]/g)) === null || A === void 0 ? void 0 : A.length) !==
                null && g !== void 0
                ? g
                : 0;
            }),
      ...
      '../../node_modules/entities/lib/encode.js'(e) {
        ...
        function d(P) {
          ...
          for (var U = 0; U < N.length - 1; U++) {
            for (
              var V = U;
              V < N.length - 1 && N[V].charCodeAt(1) + 1 === N[V + 1].charCodeAt(1);
        ...
        var y =
          ...
          A =
            String.prototype.codePointAt != null
              ...
              : function (P) {
                  return (
                    (P.charCodeAt(0) - 55296) * 1024 + P.charCodeAt(1) - 56320 + 65536
                  );
                };
        function g(P) {
          return (
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    U8 = (e, t, r, n) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let a of pg(t))
          !$8.call(e, a) &&
            a !== r &&
            cg(e, a, { get: () => t[a], enumerable: !(n = q8(t, a)) || n.enumerable });
      return e;
    },
    Qn = (e, t, r) => (
      (r = e != null ? M8(L8(e)) : {}),
  ...
  function q6() {
    (this.size = 0),
      (this.__data__ = { hash: new yg(), map: new (M6 || N6)(), string: new yg() });
  }
  var L6 = q6;
  function $6(e) {
    var t = typeof e;
...
` &&
  ...
  var vO = function (t) {
      ...
      return function (i, s) {
        try {
          if (i === '')
            return (o = []), (r = new Map([[s, '[]']])), (n = new Map()), (a = []), s;
          ...
          if (typeof s == 'string')
            return DO.test(s) ? (t.allowDate ? `_date_${s}` : void 0) : s;
          if ((0, Z8.default)(s))
  ...
  var NO = `${$g}/snippet-rendered`,
    zr = ((e) => ((e.AUTO = 'auto'), (e.CODE = 'code'), (e.DYNAMIC = 'dynamic'), e))(
      zr || {},
    );
  var X4 = q.div(Tt, ({ theme: e }) => ({
    ...
    Ku = (e) =>
      m.createElement(X4, { ...e, className: 'docblock-emptyblock sb-unstyled' }),
    J4 = q(Yr)(({ theme: e }) => ({
  ...
  var da = (e) => ({
      ...
      m.createElement(
        ...
        m.createElement(
          ...
          e
            ...
            : m.createElement(e9, { zoom: n, resetZoom: a }),
        ),
      ),
    ey = sr({ scale: 1 }),
    { window: n9 } = oe,
    ...
    km = q(ri)(({ theme: e }) => ({
      ...
      border: 'none',
      background:
        e.base === 'light' ? 'rgba(0, 0, 0, 0.85)' : Ue(0.05, e.background.content),
  ...
  var h9 = q(r9)({ position: 'absolute', top: 0, left: 0, right: 0, height: 40 }),
    ...
    y9 = () =>
      m.createElement(m9, { isLoading: !0, withToolbar: !0 }, m.createElement(ai, null)),
    b9 = q.table(({ theme: e }) => ({
      '&&': {
        borderCollapse: 'collapse',
        borderSpacing: 0,
    ...
    Hu = ({ value: e, initialExpandedArgs: t }) =>
      e == null
        ? m.createElement(F9, null)
        : m.createElement(B9, { value: e, initialExpandedArgs: t }),
    T9 = q.label(({ theme: e }) => ({
      lineHeight: '18px',
      alignItems: 'center',
      marginBottom: 8,
    ...
    O9 = ({ name: e, value: t, onChange: r, onBlur: n, onFocus: a }) => {
      let o = ge(() => r(!1), [r]);
      if (t === void 0)
        return m.createElement(Be.Button, { id: pr(e), onClick: o }, 'Set boolean');
      let u = _e(e),
    ...
    j9 = ({ name: e, value: t, onChange: r, onFocus: n, onBlur: a }) => {
      ...
      me(() => {
        o !== !1 &&
          (i && i.current && (i.current.value = I9(t)),
          s && s.current && (s.current.value = k9(t)));
      }, [t]);
      let d = (g) => {
  ...
  var L9 = ({
    ...
    qm = ({ name: e, options: t, value: r, onChange: n, isInline: a }) => {
      if (!t)
        return (
          qe.warn(`Radio with no options: ${e}`), m.createElement(m.Fragment, null, '-')
        );
      let o = ry(r, t),
        u = _e(e);
      return m.createElement(
    ...
    handleAddValueAdd({ newValue: e }) {
      ...
      a(t.length, r, n, e)
        .then(() => {
          ...
          i(r[r.length - 1], u),
            s({ type: uy, keyPath: r, deep: n, key: u.length - 1, newValue: e });
        })
        .catch(o.error);
    }
      ...
      return new Promise((r, n) => {
        ...
        a(e, u, i, s, t)
          .then(() => {
            ...
            d(u[u.length - 1], o),
              y({ type: sy, keyPath: u, deep: i, key: e, newValue: t, oldValue: s }),
              r(void 0);
          })
          .catch(n);
      });
  ...
  var fa = class extends Je {
    constructor(e) {
      super(e),
        (this.state = { data: e.data, name: e.name, keyPath: e.keyPath, deep: e.deep });
    }
    static getDerivedStateFromProps(e, t) {
      return e.data !== t.data ? { data: e.data } : null;
    }
        ...
        u
          ...
          : m.createElement(dy, {
              ...
              inputElement: (x, S, P, N) =>
                N
                  ? m.createElement(zm, { onFocus: ER, onBlur: AR })
  ...
  var SR = ({
    ...
    TR = ({ name: e, value: t, onChange: r, onFocus: n, onBlur: a, maxLength: o }) => {
      ...
      if (t === void 0)
        return m.createElement(Be.Button, { id: pr(e), onClick: d }, 'Set string');
  ...
  var RR = ({ onChange: e, name: t, accept: r = 'image/*', value: n }) => {
    ...
    LR = q.div(({ theme: e, hasDescription: t }) => ({
      color:
        e.base === 'light' ? pe(0.1, e.color.defaultText) : pe(0.2, e.color.defaultText),
      marginTop: t ? 4 : 0,
    })),
    ...
    zR = q(Te)(({ theme: e }) => ({
      ...
      width: 12,
      color:
        e.base === 'light' ? pe(0.25, e.color.defaultText) : pe(0.3, e.color.defaultText),
      border: 'none',
      display: 'inline-block',
    })),
    HR = q.span(({ theme: e }) => ({
    ...
    GR = q.td(({ theme: e }) => ({
      ...
      color:
        e.base === 'light' ? pe(0.4, e.color.defaultText) : pe(0.6, e.color.defaultText),
    ...
    eP = (e, t) => {
      ...
      let n = QR[t],
        a = (o) =>
          n ? Object.keys(o).reduce((u, i) => ({ ...u, [i]: o[i].sort(n) }), {}) : o;
      return {
        ...
        m.createElement(
          ...
          m.createElement(
            ...
            m.createElement(
              ...
              n
                ? null
                : m.createElement('th', null, m.createElement('span', null, 'Default')),
              t
                ? m.createElement(
                    'th',
                    null,
    ...
    wte = q.div(Tt, ({ theme: e }) => ({
      ...da(e),
      margin: '25px 0 40px',
      padding: '30px 20px',
    }));
  var Bte = q.div(({ theme: e }) => ({
      fontWeight: e.typography.weight.bold,
      color: e.color.defaultText,
    })),
    Tte = q.div(({ theme: e }) => ({
      color:
        e.base === 'light' ? pe(0.2, e.color.defaultText) : pe(0.6, e.color.defaultText),
    })),
  ...
  var nP = (e) => `anchor--${e}`,
    aP = ({ storyId: e, children: t }) =>
      m.createElement('div', { id: nP(e), className: 'sb-anchor' }, t);
  oe &&
    ...
    lP = (e) => {
      ...
      try {
        ...
        let y = yy(d, t),
          ...
          [E] = iP(t);
        if (!y)
          return m.createElement(St, { isLoading: !0, updateArgs: g, resetArgs: h });
  ...
  `);
      ...
      let { include: o, exclude: u, components: i, sort: s } = e,
        ...
        A = sP(e, n);
      if (d)
        return m.createElement(lP, { ...e, component: A, subcomponents: a, sort: y });
      if (!i && !a) {
        let h;
        try {
          h = { rows: by(A, r, o, u) };
  ...
  var dP = sr({ sources: {} }),
    fP = '--unknown--';
  var hP = ((e) => ((e.OPEN = 'open'), (e.CLOSED = 'closed'), (e.NONE = 'none'), e))(
      hP || {},
    ),
    gP = (e) => {
  ...
  var ti = ka.a,
    ...
    TP = (e) => {
      ...
      return m.createElement(zo, {
        ...
        options: {
          forceBlock: !0,
          overrides: { code: vP, a: xP, ...BP, ...e?.options?.overrides },
          ...e?.options,
        },
      });
    },
    ...
    IP = (e) => {
      switch (e.type) {
        ...
        case 'component': {
          ...
          return (
            r.docs?.extractComponentDescription?.(t, { component: t, parameters: r }) ||
            null
          );
        }
        default:
      ...
      return m.createElement(
        ...
        t &&
          m.createElement(
            m.Fragment,
            null,
            m.createElement(jP, null, o.name),
            m.createElement(NP, { of: e }),
          ),
        m.createElement(DP, {
          of: e,
          withToolbar: u,
    ...
    ba.addPanel(ga, {
      ...
      render: ({ key: t, active: r }) =>
        !r || !e.getCurrentStoryData()
          ? null
          : m.createElement(va, { key: t, active: r }, m.createElement(UP, null)),
    });
  });
} catch (e) {
