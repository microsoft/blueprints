    ...
    if (e && t && (r = e.constructor) === t.constructor) {
      ...
      if (r === Map) {
        ...
        for (n of e)
          if (
            ((o = n[0]),
            (o && typeof o == 'object' && ((o = Be(t, o)), !o)) || !I(n[1], t.get(o)))
          )
            return !1;
        return !0;
      }
      ...
      if (!r || typeof e == 'object') {
        n = 0;
        for (r in e)
          if ((Pe.call(e, r) && ++n && !Pe.call(t, r)) || !(r in t) || !I(e[r], t[r]))
            return !1;
  ...
  var Lt = ({ rows: e, columns: t, rowsData: r }) => {
    ...
    Ut = function* (e) {
      if (e && e.childNodes) {
        ...
        e.tagName &&
          (yield { name: 'CLOSE_TAG', data: { tagName: e.tagName }, isCloseTag: !0 });
      }
    },
  ...
  function M(e) {
    ...
    if (p) {
      ...
      return {
        ...
        alpha:
          parseFloat('' + p[4]) > 1 ? parseFloat('' + p[4]) / 100 : parseFloat('' + p[4]),
      };
    }
    throw new T(5);
  }
