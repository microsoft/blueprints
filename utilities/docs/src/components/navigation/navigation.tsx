...
import type { MainNavigationCollectionsQuery as MainNavigationCollectionsQueryType } from './navigation.types';
...
export const Navigation: FC = () => {
  ...
  const collectionsData = useStaticQuery<MainNavigationCollectionsQueryType>(
